...
class SalesOrderEditFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_sales_order_edit, container, false)
        (activity as PenjualanActivity).setActionBarTitle("EDIT SALES ORDER")
