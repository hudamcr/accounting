...
class FakturJualLihatFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_faktur_jual_lihat, container, false)
        (activity as PenjualanActivity).setActionBarTitle("LIHAT FAKTUR JUAL")
