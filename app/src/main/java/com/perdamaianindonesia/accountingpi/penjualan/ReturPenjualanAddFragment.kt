...
class ReturPenjualanAddFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_retur_penjualan_add, container, false)
        (activity as PenjualanActivity).setActionBarTitle("TAMBAH FORMULIR RETUR PENJUALAN")
