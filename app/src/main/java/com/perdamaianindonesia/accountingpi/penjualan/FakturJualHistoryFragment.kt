...
import com.perdamaianindonesia.accountingpi.penjualan.adapter.FakturJualHistoryAdapter

class FakturJualHistoryFragment : Fragment() {
    private val keuanganList = ArrayList<FakturJual>()
    private var recyclerView: RecyclerView? = null
    private var mAdapter: FakturJualHistoryAdapter? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_faktur_jual_history, container, false)
        ...
        mAdapter = FakturJualHistoryAdapter(context,keuanganList)
