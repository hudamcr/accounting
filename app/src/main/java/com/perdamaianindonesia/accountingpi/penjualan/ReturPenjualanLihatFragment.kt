...
class ReturPenjualanLihatFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_retur_penjualan_lihat, container, false)
        (activity as PenjualanActivity).setActionBarTitle("LIHAT FORMULIR RETUR PENJUALAN")
