...
public class FakturJualAdapter extends RecyclerView.Adapter<FakturJualAdapter.MyViewHolder> {
    ...
    public FakturJualAdapter(Context context,List<FakturJual> fakturjualList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rv_faktur_jual, parent, false);
