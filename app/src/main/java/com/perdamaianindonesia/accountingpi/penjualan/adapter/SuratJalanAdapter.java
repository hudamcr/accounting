...
public class SuratJalanAdapter extends RecyclerView.Adapter<SuratJalanAdapter.MyViewHolder> {

    private List<SuratJalan> suratjalanList;
    Context context;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView edit,lihat,no_sj,nama,alamat,tanggal;
    ...
    public SuratJalanAdapter(Context context,List<SuratJalan> suratjalanList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rv_surat_jalan, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment newFragment = new SuratJalanEditFragment();
